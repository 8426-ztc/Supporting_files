"""Resume-safe Codex runner: one independent call per complete cohort-batched round."""
...
def run(args: argparse.Namespace) -> None:
    ...
    state_path = prediction_dir / f"codex_inference_state{tag}.json"
    ledger_path = prediction_dir / f"codex_inference_ledger{tag}.jsonl"
